...
namespace Immortal
{
    ...
    void EditorLayer::OnEvent(Event & e)
    {
        ...
        dispatcher.Dispatch<WindowResizeEvent>(SLBIND(EditorLayer::OnResize));
        dispatcher.Dispatch<KeyPressedEvent>(SLBIND(EditorLayer::OnKeyPressed));
        dispatcher.Dispatch<MouseButtonPressedEvent>(SLBIND(EditorLayer::OnMouseButtonPressed));
    }
