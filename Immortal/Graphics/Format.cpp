...
static inline FormatElement FormatElementTable[] = {
    ...
    { Format::BayerLayerRGGB,      VK_FORMAT_R16_UNORM,                     DXF(DXGI_FORMAT_UNKNOWN            ), MTLF(MTL::PixelFormatR16Unorm             ), GL_FORMAT_R16,                 FS_C(uint16_t, 1)  },
    ...
    { Format::P010LE,              VK_FORMAT_G16_B16R16_2PLANE_420_UNORM,   DXF(DXGI_FORMAT_P010               ), MTLF(MTL::PixelFormatInvalid              ), GL_FORMAT_INVALID,             FS_C(uint16_t, 1)  },
    { Format::P016LE,              VK_FORMAT_G16_B16R16_2PLANE_420_UNORM,   DXF(DXGI_FORMAT_P016               ), MTLF(MTL::PixelFormatInvalid              ), GL_FORMAT_INVALID,             FS_C(uint16_t, 1)  },
};
