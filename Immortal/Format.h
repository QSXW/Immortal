...
static inline BaseFormatElement BaseFormatMapper[] = {
    ...
    { VK_FORMAT_R32_SINT,            DXGI_FORMAT_R32_SINT,            GL_R32I ,             FS_C(uint32_t, 1)     },
    ...
    { VK_FORMAT_R32G32_SINT,         DXGI_FORMAT_R32G32_SINT,         GL_RG32I ,            FS_C(uint32_t, 2)     },
    { VK_FORMAT_R32G32_SFLOAT,       DXGI_FORMAT_R32G32_FLOAT,        GL_RG32F,             FS_C(float,    2)     },
    { VK_FORMAT_R32G32B32_SINT,      DXGI_FORMAT_R32G32B32_SINT,      GL_RGB32I ,           FS_C(uint32_t, 3)     },
