...
public:
        ...
        : Layer("Example")
    {
        ...
        shaderLib.Get("Texture")->Set("u_Texture", 0);
    }
    ...
    void OnUpdate() override
    {
        ...
        Immortal::Render::Begin(mCamera.Camera());

        shaderLib.Get("Texture")->Map();
        shaderLib.Get("Texture")->Set("u_RGBA", mSquareColor);
        shaderLib.Get("Texture")->Set("u_Luminance", mLuminance);
        mTexture->Map();
        Immortal::Render::Submit(shaderLib.Get("Texture"), mSquareVertexArray);
    ...
    void OnEvent(Immortal::Event &e) override
    {
        ...
        dispatcher.Dispatch<Immortal::KeyPressedEvent>(SLBIND(ImageShowLayer::OnKeyPressed));
    }
